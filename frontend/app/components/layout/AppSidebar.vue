...
const handleClickOutside = (event) => {
    if (
        ...
        profilePopupRef.value &&
        profileButtonRef.value &&
        !profilePopupRef.value.contains(event.target) &&
            ...
            <ul class="mt-4 space-y-1">
                <li v-for="item in menuItems" :key="item.id" @click="handleCloseSidebar">
                    <nuxt-link :to="item.slug"
                        ...
                        <span class="text-sm mt-0.5 text-thprimary font-mono">{{ item.title }}</span>
                    </nuxt-link>
                </li>
            </ul>
        </div>
        ...
        <ul class="space-y-1 px-2">
            <li @click="handleCloseSidebar">
                <nuxt-link to="/settings"
                    ...
                    <span class="text-sm mt-0.5 text-thprimary font-mono">Settings</span>
                </nuxt-link>
            </li>
            ...
            <li @click="handleCloseSidebar">
                <nuxt-link to="/notifications"
                    ...
                    <span class="text-sm mt-0.5 text-thprimary font-mono">Notifications</span>

                    <div
                        class="size-6 rounded-full absolute right-3 top-1/2 -translate-y-1/2 bg-thprimary/8 border border-thgray-200/50 font-mono center text-xs">
                        10</div>
                </nuxt-link>
            </li>
        </ul>
