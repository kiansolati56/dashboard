...
<template>
    <div class="my-25 px-5 xl:px-10 md:my-24">
        <div
            ...
            <div>
                <h1 class="text-thprimary text-2xl font-medium flex items-center">Welcome back,
                    <span v-if="auth?.user?.name" class="ml-1">{{ auth?.user?.name }}</span>
                    <div v-else class="h-5 w-20 bg-thprimary/20 ml-1 rounded-lg animate-pulse"></div>
                    !
                </h1>
                    ...
                    <div
                        ...
                        <div class="relative size-24">
                            <div class="size-24 rounded-full center bg-thgray-200/40 border border-thgray-200">
                                <div class="absolute size-1 bg-thprimary rounded-full z-10 border border-thprimary">
                                </div>
                                <div ref="hrRef"
                        ...
                        <div class="space-y-4 mt-4">
                            <div
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex flex-col">
                                        <h3 class="text-xs sm:text-sm text-thprimary">Kian Completed task "Design
                                            header"
                                        </h3>
                                        <span class="text-xs text-thprimary/50 font-mono">Bargee</span>
                                    </div>
